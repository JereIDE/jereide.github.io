...
const WhyUsSection = () => {
  return (
    <Section
      ...
      gutterTop
      gutterBottom={20}
      style={{ background: "var(--fill-tertiary-alt)" }}
    >
      <SectionIntro>
        <Column width={7}>
          <SectionHeader>
            ...
            <Typography variant="intro-elevated" gutterTop>
              JereIDE is packed with features to simplify your gaming
              experience.
            </Typography>
          </SectionHeader>
        </Column>
      ...
      <SectionFeature
        gap={4}
        style={{ "--section-accent-color": "var(--tomato)" }}
      >
        <SectionHeader>
          <Typography
            variant="headline"
            style={{ color: "var(--section-accent-color)" }}
          >
            Navigator
          </Typography>
        </SectionHeader>
